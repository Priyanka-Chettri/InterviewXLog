...
function LoginPage({ handleLogin }) {
  return (
    <div className="flex flex-col items-start lg:h-full pl-[10px] pr-[10px] lg:pl-[150px] pt-10 ">
      ...
      <h1 className="text-[12px] w-fit lg:text-[18px] text-[#949594]">
      ...
      <div className="flex flex-col items-start lg:mt-[36px]  mt-[25px] space-y-2 text-[12px] lg:text-[17px] relative">
        ...
        <div class="absolute md:top-[29px] top-[15px] mt-2  hidden border border-r-[#949594] border-t-white border-l-white  border-b-white p-2 left-0 md:flex items-center pl-3 pointer-events-none ml-2 mb-2 pr-4">
          <img src={mail} alt="Mail Icon" class="w-5 h-5" />
        </div>
        <input
          type="text"
          id="inputText"
          class="text-box lg:w-[400px] w-[280px] h-8 lg:h-11 rounded-xl border pl-[70px] p-3"
          placeholder="Enter your email address"
        />
      </div>
      <div className="flex flex-col items-start mt-3 space-y-2 text-[12px] lg:text-[17px] relative">
        <label for="inputText" className="">
          Password
        </label>
        <div class="absolute md:top-[29px] top-[15px] hidden md:flex border border-r-[#949594] border-t-white border-l-white  border-b-white p-2 left-0 flex items-center pl-3 pointer-events-none ml-2 mb-2 pr-4">
          <img src={lock} alt="Mail Icon" class="w-5 h-5" />
        </div>
        <input
          type="password"
          id="inputText"
          class="text-box lg:w-[400px] w-[280px] h-8  lg:h-11 rounded-xl text-left border pl-[70px]"
      ...
      <button className="lg:w-[400px] w-[280px] lg:h-11 h-8  border py-3 rounded-xl flex items-center justify-center mt-6 hover:scale-105 hover:transition-all">
        <span className="">
          <img
            src={googleLogo}
            className="lg:h-6 lg:w-6 h-3 w-3 inline align-middle"
          ></img>
        </span>
      ...
      <p className="mt-6 lg:text-[14px] text-[10px]">
        ...
        <span className="text-[#4153f0] cursor-pointer" onClick={handleLogin}>
