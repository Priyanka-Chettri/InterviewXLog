...
function Categories({categoryName="companies"}) {
 ...
 const categories=CategoriesList[categoryName]
  return (
    <>
    <div className='px-5 py-10 flex flex-col border border-b-gray-200 border-t-white border-r-white border-dashed'>
     <p className='mb-2'>{categoryName.charAt(0).toUpperCase()+categoryName.slice(1)}</p>
